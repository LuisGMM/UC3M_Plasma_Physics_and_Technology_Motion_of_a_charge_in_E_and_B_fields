...
# Repeat the first simulation for positive and negative charges setting Ex/B0 = 0.2.
# The 3D trajectories or, at least their 2D projections on the XY plane, should look
# like Fig. 3.

ri, vi, ti = solve(inc_t, t_final, r0, v0, B1_B0, 0.2, w, gamma_qB, 1)
re, ve, te = solve(inc_t, t_final, r0, v0, B1_B0, 0.2, w, gamma_qB, -1)
plot1(ri, re)
...
# Why do electrons and ions drift in the same direction?
